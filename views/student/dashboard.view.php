...
<div class="flex min-h-screen bg-gray-900">
    ...
    <div class="flex-1 p-8 ">
                ...
                <div id="profilePreview" class="hidden bg-gray-800 rounded-xl p-6 mb-8 shadow-xl border border-amber-600/30">
                    <div class="flex items-center space-x-6">
                        <?php if ($user->profilePic): ?>
                            <img src="<?= '/uploads/' . $user->profilePic ?>" alt="Profile" class="w-24 h-24 rounded-full border-4 border-amber-500">
                        <?php else: ?>
        ...
        <div class="text-white">
            <!-- Quizzes Table -->
            <h2 class="text-4xl font-bold text-white" id="points">My Past Quizzes</h2>
            <br>
