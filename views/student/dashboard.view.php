      ...
      <div class="relative h-full bg-gray-900 flex flex-col space-y-6 p-6 overflow-y-auto">
        ...
        <div class="mb-8 pt-4">
          <div class="text-center bg-gradient-to-r from-amber-500 to-red-600 bg-clip-text text-transparent">
            <h2 class="text-2xl font-magic font-bold"><?= \Config\Config::HOUSES[$userDB['house_id']] ?></h2>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div id="profilePreview"
            ...
            <div class="flex items-center space-x-6">
              <?php if ($userDB['profilePicture']): ?>
                <img src="<?= '/uploads/' . ($userDB['profilePicture']) ?>" alt="Profile"
              ...
              <div class="space-y-2 flex-1">
                <h2 class="text-3xl font-bold text-amber-400"><?= ($userDB['name']) ?></h2>
                <p class="text-gray-300"><?= (\Config\Config::HOUSES[$userDB['house_id']]) ?> House</p>
          ...
          <div class="bg-gradient-to-br from-red-700/30 to-amber-600/30 rounded-xl p-6 shadow-xl border border-amber-600/30 hover:border-amber-500 transition-all duration-300 cursor-pointer group"
            ...
            <div class="flex items-center justify-between">
              <div>
                <h3 class="text-2xl font-bold text-amber-300 mb-2 group-hover:text-amber-200 transition-colors">Magical
                  Supplies Shop</h3>
                <p class="text-gray-300 group-hover:text-gray-200 transition-colors">Purchase books, wands, and magical
                  equipment</p>
              </div>
                  ...
                  <div class="flex flex-col gap-4 h-full">
                    ...
                    <?php if ($course['stat'] === null): ?>
                      <form method="POST" action="/enroll">
                        ...
                        <input type="hidden" name="student_id" value="<?= $userDB['id'] ?>">
                        <button type="submit"
                ...
                <?php foreach ($quizzesUnSolved as $quiz): ?>
                  <form action="/quizzes/attempt" method="post">
                    <div class="bg-gray-800 rounded-xl p-6 border border-amber-600/30 hover:border-amber-500 transition-all duration-300">
                      ...
                      <input type="hidden" name="student_id" value="<?= $userDB['id'] ?>">
                      <input type="hidden" name="house_id" value="<?= $userDB['house_id'] ?>">
                      <button type="submit"
                              class="w-full bg-gradient-to-r from-amber-600 to-red-700 text-white py-2 px-4 rounded-lg hover:from-amber-500 hover:to-red-600 transition-all duration-200">
                        Submit Solution
                      </button>
