                ...
                <tbody class="divide-y divide-gray-100">
                    <?php foreach ($students as $student): ?>
                        <tr class="hover:bg-gray-50/50 transition-colors group">
                            <td class="p-5 font-mono text-gray-500">#<?= htmlspecialchars($student['id']) ?></td>
                            <td class="p-5">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div class="font-semibold text-gray-900"><?= htmlspecialchars($student['name']) ?></div>
                            ...
                            <td class="p-5">
                                ...
                                <div class="flex items-center gap-2 <?= $houseColor ?>">
                                    ...
                                    <?= htmlspecialchars(\Config\Config::HOUSES[$student['house_id']]) ?>
                                </div>
                            </td>
