            ...
            <div class="space-y-2">
                ...
                <select name="course_id" required
                    ...
                    <?php foreach ($courses as $course): ?>
                        <option value="<?= htmlspecialchars($course['id']) ?>" class="py-2">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-2xl font-bold text-gryffindorRed flex items-center gap-3">
                ...
                <?= htmlspecialchars($heading) ?> Management
            </h2>
        </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php foreach ($quizzes as $quiz): ?>
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="p-4 font-medium text-gray-900">#<?= htmlspecialchars($quiz['id']) ?></td>
                            ...
                            <td class="p-4 text-gray-700"><?= htmlspecialchars($quiz['question']) ?></td>
                            <td class="p-4">
