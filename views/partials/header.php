...
.artifact-house {
    ...
    &.gryffindor { @apply bg-red-500/30 text-red-300; }
    &.slytherin { @apply bg-emerald-500/30 text-emerald-300; }
    &.ravenclaw { @apply bg-blue-500/30 text-blue-300; }
    &.hufflepuff { @apply bg-yellow-500/30 text-yellow-300; }
    &.deathly { @apply bg-gray-500/30 text-gray-300; }
}
  </style>
</head>