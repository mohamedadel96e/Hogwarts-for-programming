    ...
    <nav class="sticky top-0 w-full bg-[#740001] shadow-lg  z-10">
        ...
        <div class="mobile-menu hidden md:hidden bg-red-900">
            ...
            <div class="border-t border-red-700 mt-2 pt-2 pb-2">
                <a href="/login" class="block py-2 px-4 text-amber-100 hover:bg-red-800">Sign In</a>
                <a href="/register" class="block py-2 px-4 text-amber-100 hover:bg-red-800">Sign Up</a>
            </div>
            <?php else: ?>
            <div class="border-t border-red-700 mt-2 pt-2 pb-2">
                <a href="/logout" class="block py-2 px-4 text-amber-100 hover:bg-red-800">Logout</a>
            <?php endif; ?>
        </div>
    </nav>
