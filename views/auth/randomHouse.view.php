...
<div class="p-12 text-center hidden" id="house-card">
  ...
  <br>
  <h2 class="text-3xl text-white font-semibold mb-4">Your Wand</h2>
  <div class="flex flex-row ">
    <div>
      <h3 class="text-2xl text-white mb-2">Name: <?= $wand->name ?>"</h3>
      <p class="text-xl text-white mb-2">Magic Power: <?= $wand->magic_power ?></p>
