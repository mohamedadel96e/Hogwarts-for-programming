...
<?php include 'partials/navbar.php'; ?>
  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <a href="/dashboard"
         class="mb-6 inline-block bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
        ⮐ Back to Dashboard
      </a>
          ...
          <div class="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div class="flex-1 space-y-4">
                ...
                <div class="flex items-center space-x-6">
                  ...
                  <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                      <svg class="w-6 h-6 text-<?= strtolower(\Config\Config::HOUSES[$user->house_id]) ?>-400"
                           fill="none"
                           stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/>
                      </svg>
                      <p class="text-<?= strtolower(\Config\Config::HOUSES[$user->house_id]) ?>-400 font-semibold tracking-wider">
                        HOUSE</p>
                    </div>
              ...
              <div class="flex flex-row gap-6">
                ...
                <div class=" mt-4">
                  <p class="text-amber-400">🪄 Wand:</p>
                  <div class="flex flex-row gap-3">
                    <!--                  <img src="../../assets/wands/--><?php //= strtolower($wand->photo) ?><!--"-->
                    <!--                       alt="--><?php //= $wand->photo ?><!-- Wand"-->
                    <!--                       class="mx-auto h-10">-->
                    <p class="text-white ml-2"> Name: <?= ($wand->name) ?></p>
                    <p class="text-white ml-2"> Magic Power: <?= ($wand->magic_power) ?></p>

                  </div>
                  <!--                <div class="flex flex-row gap-3">-->
                  <!--                  <p class="text-white ml-2"> Wood: --><?php //= ($wand->wood) ?><!--</p>-->
                  <!--                  <p class="text-white ml-2"> Core: --><?php //= ($wand->core) ?><!--</p>-->
                  <!--                </div>-->
                </div>
              </div>

              <button type="submit"
                      class="mt-6 bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-lg transition-colors">
                Save Changes
              </button>
            </div>
          </div>
